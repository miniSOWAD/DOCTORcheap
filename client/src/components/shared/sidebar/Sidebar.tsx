          ...
          >
            {!isCollapsed && (
              <div className="flex items-center gap-3">
                <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-emerald-300 via-emerald-200 to-pink-200 shadow-lg ring-1 ring-white/70" />
                <div>
              ...
              >
                <Link
                  ...
                  className={`group relative flex items-center gap-4 overflow-hidden rounded-2xl px-4 py-3.5 transition-all duration-300 ${
                    active
                      ? 'bg-gradient-to-r from-emerald-400 to-emerald-300 text-white shadow-[0_10px_30px_rgba(16,185,129,0.28)]'
              ...
              {!isCollapsed ? (
                <div className="rounded-2xl bg-gradient-to-r from-emerald-100 via-white to-pink-100 p-4">
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-500">
                    Smooth, clean, and premium navigation for your medical platform.
                  </p>
                </div>
              ) : (
